...
extern void buyerSearch(string& uid);
extern void back2userSearch(string uid);
extern void adSearchOrder();
extern void back2AdSearchOrder();
extern void printSearchFailed2();
extern void printOrders2(vector<order>& orders);
extern void searchComplex2(string& str, vector<cmd>cmds, vector<cmd>& res);
extern void searchSimple2(string& str, vector<cmd>cmds, vector<cmd>& res);
extern void adSearch();
extern void back2AdSearch();
